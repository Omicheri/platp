...
Route::middleware(['auth'])->group(function () {
    ...
    Route::resource('/plats', PlatController::class)->except('destroy','edit','create','update');
    ...
    Route::put('/plats/{plat}', [PlatController::class, 'update'])->middleware(CheckPlatOwnership::class)->name('plats.update');
